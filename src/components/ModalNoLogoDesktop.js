    ...
    return (<div id="myModalNoLogo" className="modal--thanghn">
        <div className="modal-content--thanghn3">
            ...
            <div style={{display: 'flex', flex: 1, gap: 10, flexDirection: 'column',position:'relative'}}>
                ...
                <div style={{display: 'flex', flexDirection: 'column'}}>
                    <div style={{display: 'flex', flexDirection: 'row', gap:10}}>
                        <div style={{display: 'flex', flex: 1}}>
                            <img src={nologo1} style={{width: '50%', height: 'auto'}}/>
                        </div>
                        <div style={{display: 'flex', flex: 1}}>
                            <img src={nologo2} style={{width: '50%', height: 'auto'}}/>
                        </div>
                        <div style={{display: 'flex', flex: 1}}>
                            <img src={nologo3} style={{width: '50%', height: 'auto'}}/>
                        </div>
                        <div style={{display: 'flex', flex: 1}}>
                            <img src={nologo4} style={{width: '50%', height: 'auto'}}/>
                        </div>
                    </div>
                </div>
                {/*<div style={{display: 'flex', flexDirection: 'column'}}>*/}
                {/*    <div style={{display: 'flex', flexDirection: 'row', gap:10}}>*/}
                {/*        <div style={{display: 'flex', flex: 1}}>*/}
                {/*            <img src={nologo5} style={{width: '50%', height: 'auto'}}/>*/}
                {/*        </div>*/}
                {/*        <div style={{display: 'flex', flex: 1}}>*/}
                {/*            <img src={nologo6} style={{width: '50%', height: 'auto'}}/>*/}
                {/*        </div>*/}
                {/*        <div style={{display: 'flex', flex: 1}}>*/}
                {/*            <img src={nologo7} style={{width: '50%', height: 'auto'}}/>*/}
                {/*        </div>*/}
                {/*        <div style={{display: 'flex', flex: 1}}>*/}
                {/*            <img src={nologo8} style={{width: '50%', height: 'auto'}}/>*/}
                {/*        </div>*/}
                {/*    </div>*/}
                {/*</div>*/}
                {/*<div style={{display: 'flex', flexDirection: 'column'}}>*/}
                {/*    <div style={{display: 'flex', flexDirection: 'row', gap:10}}>*/}
                {/*        <div style={{display: 'flex', flex: 1}}>*/}
                {/*            <img src={nologo9} style={{width: '50%', height: 'auto'}}/>*/}
                {/*        </div>*/}
                {/*        <div style={{display: 'flex', flex: 1}}>*/}
                {/*            <img src={nologo10} style={{width: '100%', height: 'auto'}}/>*/}
                {/*        </div>*/}
                {/*        <div style={{display: 'flex', flex: 1}}>*/}
                {/*            /!*<img src={nologo7} style={{width: '100%', height: 'auto'}}/>*!/*/}
                {/*        </div>*/}
                {/*        <div style={{display: 'flex', flex: 1}}>*/}
                {/*            /!*<img src={nologo8} style={{width: '100%', height: 'auto'}}/>*!/*/}
                {/*        </div>*/}
                {/*    </div>*/}
                {/*</div>*/}
            </div>
