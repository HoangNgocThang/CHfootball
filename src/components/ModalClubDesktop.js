        ...
        <div className="modal-content--thanghn4" style={{height:650}}>
            <div style={{display: 'flex', flex: 1, gap: 10, flexDirection: 'column', position: 'relative'}}>
                <div style={{padding: 20, display: 'flex', flexDirection: 'row', flex: 1, backgroundColor: '#061F4D'}}>
                    <img src={maucaulacbocosan} style={{
                ...
                <div className="container-products" style={{margin: 10}}>
                    ...
                    <div className='iteamcard'>
                        <img src={clb2} className={"container-customer-img3"} alt={'customer'}/>
                        <img src={clb3} className={"container-customer-img3"} alt={'customer'}/>
                    </div>
                    <div className='iteamcard'>
                        <img src={clb4} className={"container-customer-img3"} alt={'customer'}/>
                        <img src={clb5} className={"container-customer-img3"} alt={'customer'}/>
                    </div>
                    <div className='iteamcard'>
                        <img src={clb6} className={"container-customer-img3"} alt={'customer'}/>
                        <img src={clb7} className={"container-customer-img3"} alt={'customer'}/>
                    </div>
                </div>
            </div>
        </div>
